...
def oneOpLHS
  {GAS_CELL ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL _Val6 _Val8 : SortInt}
...
def oneOpRHS
  {TOP_STACK ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL _Val6 _Val8 : SortInt}
  -- We assume `GASPRICE_CELL` is not negative
  {GASPRICE_CELL : ℕ}
  {SCHEDULE_CELL : SortSchedule}
  {WS : SortWordStack}
...
theorem rw_oneOpLHS_oneOpRHS
  {GAS_CELL ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL _Val0 _Val2 _Val6 _Val7 _Val8 : SortInt}
  -- We assume `GASPRICE_CELL` is not negative
  {GASPRICE_CELL : ℕ}
  {SCHEDULE_CELL : SortSchedule}
  ...
  (req : _Val5 = true):
  let lhs := (@oneOpLHS op GAS_CELL ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL _Val6 _Val8 GASPRICE_CELL SCHEDULE_CELL USEGAS_CELL WS _DotVar0 _DotVar2 _Gen0 _Gen1 _Gen10
  _Gen11 _Gen12 _Gen13 _Gen14 _Gen15 _Gen16 _Gen19
  _Gen20 _Gen21 _Gen22 _Gen3 _Gen4 _Gen5 _Gen6 _Gen7 _Gen8 _Gen9 _K_CELL)
  let rhs := (@oneOpRHS (op.do lhs) ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL _Val6 _Val8 GASPRICE_CELL SCHEDULE_CELL WS _DotVar0 _DotVar2 _Gen0 _Gen1 _Gen10 _Gen11 _Gen12 _Gen13 _Gen14 _Gen15 _Gen16 _Gen19 _Gen20 _Gen21 _Gen22 _Gen3 _Gen4 _Gen5 _Gen6 _Gen7 _Gen8 _Gen9 _K_CELL)
  Rewrites lhs rhs
   := by
...
theorem oneOp_poststate_equiv
  {TOP_STACK ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL _Val5 _Val6 _Val8 : SortInt}
  -- We assume `GASPRICE_CELL` is not negative
  {GASPRICE_CELL : ℕ}
  {SCHEDULE_CELL : SortSchedule}
  {WS : SortWordStack}
  ...
  (defn_Val6 : «_+Int_» PC_CELL 1 = some _Val6)
  (symState : EVM.State):
  let rhs := (@oneOpRHS TOP_STACK ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL _Val6 _Val8 GASPRICE_CELL SCHEDULE_CELL WS _DotVar0 _DotVar2 _Gen0 _Gen1 _Gen10 _Gen11 _Gen12 _Gen13 _Gen14 _Gen15 _Gen16 _Gen19 _Gen20 _Gen21 _Gen22 _Gen3 _Gen4 _Gen5 _Gen6 _Gen7 _Gen8 _Gen9 _K_CELL)
...
theorem step_oneOp_equiv
  ...
  rw [@oneOp_poststate_equiv _ ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL]
  <;> try assumption
...
theorem X_oneOp_equiv
  ...
  (TIMESTAMP_CELL_small : TIMESTAMP_CELL < UInt256.size)
  (TIMESTAMP_CELL_nonneg : 0 ≤ TIMESTAMP_CELL) :
  let lhs := (@oneOpLHS op GAS_CELL ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL PC_CELL _Val6 _Val8 GASPRICE_CELL SCHEDULE_CELL USEGAS_CELL WS _DotVar0 _DotVar2 ⟨op.from_k.to_bin⟩ _Gen1 _Gen10
  _Gen11 _Gen12 _Gen13 _Gen14 _Gen15 _Gen16 _Gen19
  _Gen20 _Gen21 _Gen22 _Gen3 _Gen4 _Gen5 _Gen6 _Gen7 _Gen8 _Gen9 _K_CELL)
  let rhs := (@oneOpRHS (op.do lhs) ID_CELL ORIGIN_CELL CALLER_CELL COINBASE_CELL TIMESTAMP_CELL MIXHASH_CELL _Val6 _Val8 GASPRICE_CELL SCHEDULE_CELL WS _DotVar0 _DotVar2 _Gen0 _Gen1 ⟨.empty⟩ _Gen11 _Gen12 _Gen13 _Gen14 _Gen15 _Gen16 _Gen19 _Gen20 _Gen21 _Gen22 _Gen3 _Gen4 _Gen5 _Gen6 _Gen7 _Gen8 _Gen9 _K_CELL)
  ...
  . generalize h_top_stack : op.do lhs = top_stack
    ...
    --. -- `address`
      ...
      aesop (add simp [Fin.val, Fin.ofNat, AccountAddress.size, State.coinBase])
      (add safe (by omega))
