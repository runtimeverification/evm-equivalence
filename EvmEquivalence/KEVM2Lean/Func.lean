...
axiom «padRightBytes(_,_,_)_BYTES-HOOKED_Bytes_Bytes_Int_Int» (x0 : SortBytes) (x1 : SortInt) (x2 : SortInt) : Option SortBytes
...
axiom «.Bytes_BYTES-HOOKED_Bytes» : Option SortBytes

axiom «replaceAtBytes(_,_,_)_BYTES-HOOKED_Bytes_Bytes_Int_Bytes» (x0 : SortBytes) (x1 : SortInt) (x2 : SortBytes) : Option SortBytes

axiom «lengthBytes(_)_BYTES-HOOKED_Int_Bytes» (x0 : SortBytes) : Option SortInt
...
axiom «maxInt(_,_)_INT-COMMON_Int_Int_Int» (x0 : SortInt) (x1 : SortInt) : Option SortInt

axiom «.AccountCellMap» : Option SortAccountCellMap

axiom «padLeftBytes(_,_,_)_BYTES-HOOKED_Bytes_Bytes_Int_Int» (x0 : SortBytes) (x1 : SortInt) (x2 : SortInt) : Option SortBytes
...
axiom «Int2Bytes(_,_,_)_BYTES-HOOKED_Bytes_Int_Int_Endianness» (x0 : SortInt) (x1 : SortInt) (x2 : SortEndianness) : Option SortBytes

axiom «log2Int(_)_INT-COMMON_Int_Int» (x0 : SortInt) : Option SortInt

axiom «~Int_» (x0 : SortInt) : Option SortInt
...
noncomputable def _e985b28 : SortInt → SortInt → Option SortInt
  | I1, I2 => do
...
noncomputable def _a656ca7 : SortBytes → SortInt → SortBytes → Option SortBytes
...
noncomputable def _ea9648a : SortInt → SortEndianness → SortSignedness → Option SortBytes
  | I, _Gen0, _Gen1 => do
...
noncomputable def _ebfe294 : SortInt → SortBytes → Option SortBytes
  | N, BS => do
...
noncomputable def _6c109c0 : SortInt → SortEndianness → SortSignedness → Option SortBytes
...
noncomputable def _20f05d9 : SortInt → SortEndianness → SortSignedness → Option SortBytes
  | I, E, SortSignedness.signedBytes => do
    let _Val0 <- «_>Int_» I 0
...
noncomputable def _e9743d5 : SortInt → SortEndianness → SortSignedness → Option SortBytes
...
noncomputable def _43f856e : SortInt → SortEndianness → SortSignedness → Option SortBytes
  | I, E, SortSignedness.signedBytes => do
    let _Val0 <- «_<Int_» I (-1)
    let _Val1 <- «~Int_» I
...
noncomputable def _8096892 : SortInt → SortInt → SortInt → Option SortInt
  | MU, _Gen0, WIDTH => do
...
noncomputable def _f03fd7e : SortBytes → SortInt → SortBytes → Option SortBytes
  | WS, START, WS' => do
...
noncomputable def «_up/Int__EVM-TYPES_Int_Int_Int» (x0 : SortInt) (x1 : SortInt) : Option SortInt := (_091b7da x0 x1) <|> (_50d266e x0 x1) <|> (_5321d80 x0 x1) <|> (_e985b28 x0 x1)
...
noncomputable def Int2BytesNoLen (x0 : SortInt) (x1 : SortEndianness) (x2 : SortSignedness) : Option SortBytes := (_20f05d9 x0 x1 x2) <|> (_43f856e x0 x1 x2) <|> (_6c109c0 x0 x1 x2) <|> (_e9743d5 x0 x1 x2) <|> (_ea9648a x0 x1 x2)
...
noncomputable def «#padToWidth» (x0 : SortInt) (x1 : SortBytes) : Option SortBytes := (_67678cd x0 x1) <|> (_ebfe294 x0 x1)

noncomputable def «_=/=Int_» (x0 : SortInt) (x1 : SortInt) : Option SortBool := _4de6e05 x0 x1

noncomputable def _86ca6df : SortInt → SortInt → SortInt → Option SortInt
  | MU, START, WIDTH => do
    let _Val0 <- «_<Int_» 0 WIDTH
...
noncomputable def _fdd6ce1 : SortInt → Option SortBytes
  | W => do
...
noncomputable def _8391694 : SortBytes → SortInt → SortBytes → Option SortBytes
  | WS, START, WS' => do
    let _Val0 <- «_<=Int_» 0 START
    let _Val1 <- «lengthBytes(_)_BYTES-HOOKED_Int_Bytes» WS'
    let _Val2 <- «_=/=Int_» _Val1 0
...
noncomputable def «#memoryUsageUpdate» (x0 : SortInt) (x1 : SortInt) (x2 : SortInt) : Option SortInt := (_8096892 x0 x1 x2) <|> (_86ca6df x0 x1 x2)

noncomputable def «#asByteStack» (x0 : SortInt) : Option SortBytes := _fdd6ce1 x0
...
noncomputable def mapWriteRange (x0 : SortBytes) (x1 : SortInt) (x2 : SortBytes) : Option SortBytes := (_8391694 x0 x1 x2) <|> (_a656ca7 x0 x1 x2) <|> (_f03fd7e x0 x1 x2)
